...
function applyFilters(hash = '') {
    ...
    categoryFilterObj.addEventListener('change', function() {
        ...
        filterJobs(hash, `?category=${selectedCategory}&location=${selectedLocation}&search_term=${searchTerm}&sort=${selectedSort}`);
    });
    ...
    document.getElementById('sorting-filter').addEventListener('input', function() {
    ...
    //html for main_content to apend
        var main_html= `  <!-- Hero section -->
            ...
            <main id="jobs-section">
                ...
                <section id="details-sectn" class="my-3 details-section  container  p-5 mb-2" style="display: none;">
